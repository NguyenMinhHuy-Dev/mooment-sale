...
export default function Account() {
  ...
  return (
    <>
        <div className='relative category mx-1min-w-[100px] px-2 h-[80%] text-[13px] flex justify-center items-center' onClick={(e) => setIsOpen(true)}>
            <AccountCircleOutlinedIcon className='myicon  cursor-pointer '/>
            <p className=' cursor-pointer '>Đăng nhập</p>

            <div className='mymenu absolute w-[300px] shadow-menu p-4 rounded-lg mt-[12px] top-full  right-0 bg-white'>
